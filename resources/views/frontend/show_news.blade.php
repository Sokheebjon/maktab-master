        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <p><img src="{{URL::to($news->image)}}" alt="..." class="img-fluid"></p>
                    ...
                    <div class="post-author mt-5">
                        <div class="d-flex">
                            <div class="avatar"><img
                                    src="../../../d19m59y37dris4.cloudfront.net/university/1-1-1/img/avatar-2.jpg"
                        ...
                        <div class="comment">
                            <div class="d-flex">
                                <div class="left d-flex flex-column align-items-center mr-3">
                                    <div class="avatar"><img
                                            src="../../../d19m59y37dris4.cloudfront.net/university/1-1-1/img/avatar-3.jpg"
                                            alt="..." class="img-fluid"></div>
                                    <a href="#" class="reply"><i class="fa fa-reply"></i></a>
                                </div>
                                <div class="right">
                                    <div class="info"><a href="#" class="no-anchor-style"><strong>Frank
                                                Wood</strong></a>
                            ...
                            <div class="comment">
                                <div class="d-flex">
                                    ...
                                    <div class="right">
                                        <div class="info"></div>
                                        <a href="#" class="no-anchor-style"> <strong>Frank Wood</strong></a>
                                        <div class="date"><i class="fa fa-calendar"></i>14 August 2018</div>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                                            tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
                                            quis nostrud exercitation ullamco </p>
                        ...
                        <div class="widget categoris">
                            ...
                            <div class="widget-body">
                                <ul class="categoris-list list-unstyled">
                                    @foreach(\App\Models\Category::getCategoryCount() as $key => $cat)
                                    <li class="@if($key+1 === count(\App\Models\Category::getCategoryCount())) border-bottom-0 pb-0 @endif">
                                        <a href="{{route('all_news', $cat->id)}}" class="d-flex align-items-end justify-content-between"><strong>{{$cat->name_uz}}</strong><strong>{{$cat->news_count}}</strong></a>
                                    </li>
                                    @endforeach
                                </ul>
                            </div>
