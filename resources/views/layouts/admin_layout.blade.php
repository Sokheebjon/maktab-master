...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="text-center sidebar-brand-wrapper d-flex align-items-center">
        <a class="sidebar-brand brand-logo" href="{{url('admin/')}}"><img src="/images/logo.svg" alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini pl-4 pt-3" href="{{url('admin/')}}"><img src="/images/logo-mini.svg" alt="logo" /></a>
    </div>
    <ul class="nav">
        <li class="nav-item">
            <a class="nav-link" href="{{url('admin/')}}">
                <i class="mdi mdi-home menu-icon"></i>
                <span class="menu-title">{{__('admin_layout.Home')}}</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{url('admin/category/')}}">
                    <i class="mdi mdi-apps menu-icon"></i>
                <span class="menu-title">{{__('admin_layout.Category')}}</span>
            </a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{route('admin.all_teacher')}}">
                <i class="mdi mdi-account menu-icon"></i>
                <span class="menu-title">Teachers</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{{route('admin.all_student')}}">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{url('admin/type/')}}">
                ...
                <span class="menu-title">Test type</span>
            </a>
        </li>
        <li class="nav-item">
