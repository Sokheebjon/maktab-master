        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <form class="forms-sample" method="POST" action="{{ route('admin.group.store') }}">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-6">
                                        ...
                                        <select class="form-control form-control-lg @error('teacher_id') is-invalid @enderror" name="teacher_id" id="exampleFormControlSelect1">
